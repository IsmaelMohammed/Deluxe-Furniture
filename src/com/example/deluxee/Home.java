...
public class Home extends ActionBarActivity implements FetchDataListener, OnItemClickListener  {
	int mPosition = -1;	
	String mTitle = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#297484")));
    	 li=(ListView)findViewById(R.id.list);
		// Getting an array of country names
		mlabel = getResources().getStringArray(R.array.homMenu);
        ...
        mDrawerList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                case 0:
                    ...
                    break;
                case 1:
                	Intent list=new Intent(Home.this,ProdList.class);
                	startActivity(list);
                    break;
                
                case 2:
                	Intent userlist=new Intent(Home.this,Userlist.class);
                ...
                case 3:
              	...
              	Intent change=new Intent(Home.this,Change_Password.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			Intent hom=new Intent(Home.this,MainActivity.class);
			startActivity(hom);
			break;
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		TextView c3 = (TextView)curr.findViewById(R.id.titleTxt6);
		 ...
		 Intent disp=new Intent(Home.this,Product_Display.class);
		 
		 disp.putExtra("user", "admin");
