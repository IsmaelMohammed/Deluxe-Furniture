...
public class Seller extends ActionBarActivity implements FetchDataListener, OnItemClickListener  {
	int mPosition = -1;	
	String mTitle = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mlabel = getResources().getStringArray(R.array.SellerMenu);
        ...
        mDrawerList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                case 1:
                	...
                	Intent list=new Intent(Seller.this,Orderd_Prod_list.class);
                	list.putExtra("uname", uname);
                    list.putExtra("psw", pswe);
                	list.putExtra("usr", "seller");
                	startActivity(list);
                    break;
                
                case 2:
                	String soldu=getIntent().getExtras().getString("uname");
                  	 
                  	 String soldp=getIntent().getExtras().getString("psw");
                	Intent sold=new Intent(Seller.this,Sold_out_product.class);
               	 sold.putExtra("uname", soldu);
               	 sold.putExtra("operation", "sold");
               	sold.putExtra("typ", "seller");
                    sold.putExtra("psw", soldp);
                    startActivity(sold);
                    break;
                ...
                case 4:
              	...
              	Intent change=new Intent(Seller.this,Change_Password.class);
                ...
                case 3:
             	...
             	Intent soldo=new Intent(Seller.this,Sold_out_product.class);
            	 soldo.putExtra("uname", soldnam);
               	 soldo.putExtra("operation", "soldout");
               	 soldo.putExtra("typ", "seller");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			Intent hom=new Intent(Seller.this,MainActivity.class);
			startActivity(hom);
			break;
		}
	...
	private void Get_product() {
		...
		String url = "http://192.168.43.116/getpro.php";
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		String Pid=c3.getText().toString();
		 ...
		 Intent disp=new Intent(Seller.this,Product_Display.class);
